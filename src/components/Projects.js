  ...
  return(
    <div>
      ...
      <div className="project">
        ...
        <a href="https://albertfelix.com/" target="_blank" rel="noreferrer" >https://albertfelix.com/</a>
      </div>
      <div className="project">
        ...
        <a href="https://albert-felix-meeting-room.netlify.app/" target="_blank" rel="noreferrer" >https://albert-felix-meeting-room.netlify.app/</a>
      </div>
    </div>
  )
}
